...
<head>
  ...
  <link rel="stylesheet" href="<?php echo URI_BASE ?>/h5.css" media="screen, projection" />
  <link rel="stylesheet" href="<?php echo URI_BASE ?>/assets/style.css" media="screen, projection" />
</head>
